			...
			<div class="wrapper mod-standard mod-gray">
				<div class="details-banner">
					...
					<div class="details-banner--hero">
						<asp:Image runat="server" CssClass="details-banner--hero--img" ID="imgArtistHero"/>
						<%--<img class="" src="./PageToSync/img/31.jpg" 
						srcset="./PageToSync/img/31.jpg, 
						./PageToSync/img/31.jpg 2x" alt="Bethel Music">--%>
					</div>
					<div class="details-banner--info">
						<a href="#" class="details-banner--info--box">
								<%--<img class="details-banner--info--box--img"
								 ...
								 srcset="./PageToSync/img/174-sm.jpg,
								 			./PageToSync/img/174.jpg 2x"
							     alt="alt">--%>
							<asp:Image runat="server" ID="imgArtistProfile" CssClass="details-banner--info--box--img"/>
						</a>
				...
				<div class="discovery--container u-container">
							<main class="discovery--section">
								...
								<section class="standard--holder">
									...
									<asp:Repeater runat="server" ID="rptSongs">
										<ItemTemplate>
											<ul id="playlist" class="song-list mod-new mod-menu">
												<li class="song-list--item media-player--row">
													...
													<div class="song-list--item--player-img media-player">
														...
														src="<%#Eval("AlbumImage") %>" alt="Way Maker">
													</div>
												...
												<asp:Repeater runat="server" ID="rptAlbums">
													<ItemTemplate>
														<div class="media-item">
															...
															<a class="media-item--subtitle" href="#" tabindex="0"><%#DtArtist.Rows[0]["title"] %></a>
														</div>
													</ItemTemplate>
												</asp:Repeater>
											</div><!-- /.grid -->
								...
								<section class="standard--holder">
									...
									<div class="artist-details--biography biography">
										<p>
											<asp:Literal runat="server" ID="txtBiography">
